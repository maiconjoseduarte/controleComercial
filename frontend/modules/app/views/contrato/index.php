...
/* @var $searchModel frontend\modules\app\models\ContratoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Contratos';
$this->params['breadcrumbs'][] = $this->title;

$canCreate = Yii::$app->user->can('app/contrato/create');
$canUpdate = Yii::$app->user->can('app/contrato/update');
$canDelete = Yii::$app->user->can('app/contrato/delete');
?>
<div class="row">
