...
class Contrato extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'idGrupo' => 'Grupo',
            'dataInicio' => 'Início Contrato',
            'totalReceitaLiquidaInicio' => 'R. Líquida',
            'margemBrutaPonderada' => 'MB',
            'dataUltimaRenovacao' => 'Última Renovacao',
            'vencimento' => 'Vencimento',
            'reajustePonderado' => 'Reajuste Ponderado',
            'margemBrutaPonderadaRenovacao' => 'MB Renovação',
            'totalReceitaLiquidaRenovacao' => 'R. Líquida Renovação',
            'condicaoPagamento' => 'Cod. Pagamento',
            'minimo' => 'Mínimo',
            'numeroLeitos' => 'Nº Leitos',
            'tabela' => 'Tabela',
            'icms' => 'Icms',
